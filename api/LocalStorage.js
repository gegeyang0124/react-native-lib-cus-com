...
const Storage = Components.react_native_storage;
...
export class LocalStorage {
    ...
    static verfyComponent(){
        ...
        if(!JPushModule.initPush){
            console.info("请安装持久化本地存储组件","react-native-storage");
            Tools.toast("请安装组件 react-native-storage");
            b = false;
        }
