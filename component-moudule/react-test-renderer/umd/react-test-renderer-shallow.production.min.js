 ...
 */
'use strict';(function(e,g){"object"===typeof exports&&"undefined"!==typeof module?module.exports=g(require("react")):"function"===typeof define&&define.amd?define(["react"],g):e.ReactShallowRenderer=g(e.React)})(this,function(e){function g(a){for(var b=arguments.length-1,f="http://reactjs.org/docs/error-decoder.html?invariant\x3d"+a,c=0;c<b;c++)f+="\x26args[]\x3d"+encodeURIComponent(arguments[c+1]);v(!1,"Minified React error #"+a+"; visit %s for the full message or use the non-minified dev environment for full errors and additional helpful warnings. ",
f)}function p(a){if("object"===typeof a&&null!==a){var b=a.$$typeof;switch(b){case w:switch(a=a.type,a){case x:case y:case z:return a;default:switch(a=a&&a.$$typeof,a){case A:case n:case B:return a;default:return b}}case C:return b}}}function q(a,b){return a===b?0!==a||0!==b||1/a===1/b:a!==a&&b!==b}function r(a,b){if(!(a instanceof b))throw new TypeError("Cannot call a class as a function");}var t=e.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.assign,v=function(a,b,f,c,d,h,g,E){if(!a){if(void 0===
b)a=Error("Minified exception occurred; use the non-minified dev environment for the full error message and additional helpful warnings.");else{var D=[f,c,d,h,g,E],e=0;a=Error(b.replace(/%s/g,function(){return D[e++]}));a.name="Invariant Violation"}a.framesToPop=1;throw a;}},d="function"===typeof Symbol&&Symbol["for"],w=d?Symbol["for"]("react.element"):60103;d&&Symbol["for"]("react.call");d&&Symbol["for"]("react.return");var C=d?Symbol["for"]("react.portal"):60106,y=d?Symbol["for"]("react.fragment"):
60107,z=d?Symbol["for"]("react.strict_mode"):60108,B=d?Symbol["for"]("react.provider"):60109,A=d?Symbol["for"]("react.context"):60110,x=d?Symbol["for"]("react.async_mode"):60111,n=d?Symbol["for"]("react.forward_ref"):60112,l={},F=Object.prototype.hasOwnProperty,u=function(a,b){if(q(a,b))return!0;if("object"!==typeof a||null===a||"object"!==typeof b||null===b)return!1;var f=Object.keys(a),c=Object.keys(b);if(f.length!==c.length)return!1;for(c=0;c<f.length;c++)if(!F.call(b,f[c])||!q(a[f[c]],b[f[c]]))return!1;
return!0},m=function(){function a(){r(this,a);this._rendered=this._newState=this._instance=this._element=this._context=null;this._forcedUpdate=this._rendering=!1;this._updater=new G(this)}a.prototype.getMountedInstance=function(){return this._instance};a.prototype.getRenderOutput=function(){return this._rendered};a.prototype.render=function(b){var a=1<arguments.length&&void 0!==arguments[1]?arguments[1]:l;e.isValidElement(b)?void 0:g("12","function"===typeof b?" Instead of passing a component class, make sure to instantiate it by passing it to React.createElement.":
...
"function"!==typeof this._instance.getSnapshotBeforeUpdate&&("function"===typeof this._instance.componentWillUpdate&&this._instance.componentWillUpdate(c,e,a),"function"===typeof this._instance.UNSAFE_componentWillUpdate&&this._instance.UNSAFE_componentWillUpdate(c,e,a));this._instance.context=a;this._instance.props=c;this._instance.state=e;k&&(this._rendered=this._instance.render())};a.prototype._updateStateFromStaticLifecycle=function(b){var a=this._element.type;"function"===typeof a.getDerivedStateFromProps&&
(b=a.getDerivedStateFromProps.call(null,b,this._instance.state),null!=b&&(b=t({},this._newState||this._instance.state,b),this._instance.state=this._newState=b))};return a}();m.createRenderer=function(){return new m};var G=function(){function a(b){r(this,a);this._renderer=b;this._callbacks=[]}a.prototype._enqueueCallback=function(b,a){"function"===typeof b&&a&&this._callbacks.push({callback:b,publicInstance:a})};a.prototype._invokeCallbacks=function(){var a=this._callbacks;this._callbacks=[];a.forEach(function(a){a.callback.call(a.publicInstance)})};
...
a.state;"function"===typeof d&&(d=d(c,a.props));this._renderer._newState=t({},c,d);this._renderer.render(this._renderer._element,this._renderer._context)};return a}();d=(d=Object.freeze({default:m}))&&m||d;return d["default"]?d["default"]:d});
