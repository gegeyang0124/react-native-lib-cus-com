...

    {
      ...
      if (typeof newChildrenIterable.entries === 'function') {
        ...
        if (possibleMap.entries === iteratorFn) {
          !didWarnAboutMaps ? warning_1(false, 'Using Maps as children is unsupported and will likely yield ' + 'unexpected results. Convert it to a sequence/iterable of keyed ' + 'ReactElements instead.%s', getCurrentFiberStackAddendum$1()) : void 0;
      ...
      outer: while (true) {
        ...
        switch (node.tag) {
          ...
          case ForwardRef:
            ...
            break;
          default:
            invariant_1(false, 'Unsupported component type %s in test renderer. This is probably a bug in React.', node.tag);
        }
